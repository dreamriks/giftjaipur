...
<?php } ?>
        ...
        <div class="maxiroundedcenter">
            ...
            $styles = ' style="float: '.$params->get('logoposition','left').';margin: '.$params->get('logomargintop','0').'px '.$params->get('logomarginright','0').'px '.$params->get('logomarginbottom','0').'px '.$params->get('logomarginleft','0').'px"';
...
//    $stopdropdown = ($item->level > 120) ? '-nodrop' : '';
    ...
    if (isset($item->content) AND $item->content) {
        echo '<li class="maximenuck' . $stopdropdownclass . $item->classe . ' level' . $item->level .' '.$item->liclass . '">' . $item->content;
		$item->ftitle = '';
    } 
