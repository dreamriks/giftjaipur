		   ...
		   <td class="ui-state-default" style="background-position: 50% 0;">
		     <ul class="toolBox ">
	          <li class="edit_row" id="layout_addRow" style="background-position: 50% 0;">
			    <span class="caption" ><?php echo jText::sprintf('TPL_FIRST_FIRST_FIRST_SPARKY_ADD_ROW') ;?></span>
 			    <table cellpadding="0" cellspacing="0">
				 <tr>
                 <td>	
				    <table cellpadding="0" cellspacing="0">
				     <tr><td><a href="javasctipt:void(0);" class="deleteRow"></a></td><td><span><?php echo jText::sprintf('TPL_FIRST_FIRST_FIRST_SPARKY_NAME') ;?></span></td><td> <input style="width:65px;" type="text" class="layoutrow_name" value="" /> </td></tr>
                     <tr><td></td><td><span><?php echo jText::sprintf('TPL_FIRST_FIRST_FIRST_SPARKY_CLASS') ;?></span></td><td> <input style="width:65px;" type="text" class="layoutrow_class" value="" /> </td></tr>					 
					</table>
				 </td>
				 <td>
			  ...
			  <li class="ui-state-default" style="background-position: 50% 0;">
			     <span class="caption" ><?php echo jText::sprintf('TPL_FIRST_FIRST_FIRST_SPARKY_UNASSIGNED_MODULE_POSTIONS'); ?></span>
			     <ul class="unassignedPositions drag_module_postions" >
				 <?php
					global $tadmin_mpos; 
					echo '<li wX="1" off="0" mp="joom_content" class="mpos_draggable cpos" ><span>['.jText::sprintf('TPL_FIRST_FIRST_FIRST_SPARKY_CONTENT_BOX').']</span><div class="clr" ></div><a title="Move left" href="javascript:void(0);" class="off_left"  >.</a><a  title="Move right" href="javascript:void(0);" class="off_right" >.</a></li>';
                    ...
                    //echo '<li wX="1" mp="joom_empty" class="mpos_draggable emptycell" >['.jText::sprintf('TPL_FIRST_FIRST_FIRST_SPARKY_EMPTY').']</li>';					
			      ?>
				 </ul>
			  </li>
             </ul>
			   ...
			   window.setInterval( function(){
			     ...
			     if( jQuery('#layoutdesigner<?php echo $this->id; ?> #sortable .edit_row').length == 0){
					 if( jQuery('#layoutdesigner<?php echo $this->id; ?> #sortable .initialRow').length == 0){
					   jQuery('#layoutdesigner<?php echo $this->id; ?> #sortable').append(jQuery('<li class="initialRow"><?php echo jText::sprintf('TPL_FIRST_FIRST_FIRST_SPARKY_ADD_DRAG'); ?></li>')); 
					 }
				 }else{
				     if( jQuery('#layoutdesigner<?php echo $this->id; ?> #sortable .initialRow').length > 0){
