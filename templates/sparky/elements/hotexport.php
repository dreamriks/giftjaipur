...
class JFormFieldHotexport extends JFormField
{
	...
	protected function getInput()
	{
		...
		?>
			...
			<tr>
			<td >
			<label for="<?php echo $this->id; ?>"><?php echo jText::sprintf("TPL_SPARKY_EXPORT_NAME") ?></label>
			</td>
			...
			<td>
			<button onclick="doExport('<?php echo $jbase; ?>','templates/sparky/elements/doexport.php',jQuery('#<?php echo $this->id; ?>').val());return false;" >Export</button>
