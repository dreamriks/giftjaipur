	...
	protected function getInput()
	{
		...
		<div formenu="nav" class="menu_parms_panel" style="display:none">
		    <table>
				...
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_FONT_FAMILY_LBL'); ?></label></td>
					<td>
						<input parameter="font_family" type="text" filter="raw" value="Arial, Helvetica, sans-serif" autocomplete="off" /> 
					</td>
				</tr>
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_FONT_SIZE_LBL'); ?></label></td>
					<td><input parameter="font_size" type="text" value="14" autocomplete="off" size="3" /></td>
				</tr>
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_TEXT_ALIGN_LBL'); ?></label></td>
					<td>
				...
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_FONT_WEIGHT_LBL'); ?></label></td>
					<td>
				...
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_FONT_STYLE_LBL'); ?></label></td>
					<td>
		...
		<div formenu="navh" class="menu_parms_panel" style="display:none">
			<table>
				...
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_MNU_HORIZONTAL_PANE_COLOR_LBL'); ?></label></td>
					<td><input parameter="tab_color" type="text" class="pckcolor" value="#DDDDDD" autocomplete="off" /></td>
				</tr>
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_MNU_HORIZONTAL_PANE_HEIGHT_LBL'); ?></label></td>
					<td><input parameter="tab_height" type="text" value="40" autocomplete="off" size="3" /></td>
				</tr>
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_MNU_HORIZONTAL_PADDING_LBL'); ?></label></td>
				...
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_MNU_PANE_COLOR_LBL'); ?></label></td>
					<td><input parameter="tab_color_sub_sub" type="text" class="pckcolor" value="#782320" autocomplete="off" /></td>
				</tr>
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_MNU_HORIZONTAL_PANE_WIDTH_LBL'); ?></label></td>
					<td><input parameter="tab_width_sub_sub" type="text" value="150" autocomplete="off" size="3" /></td>
				</tr>
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_MNU_HORIZONTAL_PANE_PADDING_LBL'); ?></label></td>
					<td><input parameter="horiz_pane_padding_sub_sub" type="text" value="15" autocomplete="off" size="3" /></td>
				</tr>
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_MNU_HORIZONTAL_MENU_ITEM_HEIGHT'); ?></label></td>
		...
		<div formenu="acc" class="menu_parms_panel" style="display:none">
			<table>
				...
				<tr>
					...
					<td><label><?php echo jText::sprintf('TPL_SPARKY_FONT_SIZE_SUB_LBL'); ?></label></td>
					<td><input parameter="font_size_sub" type="text" value="12" autocomplete="off" size="3" /> </td>
				</tr>
				<tr>
				...
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_MNU_ACCORDION_PANE_BG'); ?></label></td>
					<td><input parameter="accordion_pane_bg" type="text" class="pckcolor" value="#CCCCCC" autocomplete="off" /> </td>
				</tr>
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_MNU_ACCORDION_PANE_BORDER_COLOR'); ?></label></td>
					<td><input parameter="accordion_pane_border_color" type="text" class="pckcolor" value="#000000" autocomplete="off" /> </td>
				</tr>
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_MNU_ACCORDION_PANE_BORDER_SIZE'); ?></label></td>
					<td><input parameter="accordion_pane_border_size" type="text" value="1" autocomplete="off" size="3" /> </td>
				</tr>
				<tr>
					<td><label><?php echo jText::sprintf('TPL_SPARKY_MNU_ACCORDION_PANE_BORDER_RADIUS'); ?></label></td>
