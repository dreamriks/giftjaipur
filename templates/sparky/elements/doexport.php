...
if($content) {
	$content = str_replace('sparky', $alias, $content);
	$content = str_replace('SPARKY', $aliasU, $content);
	$content = str_replace('sparky', $nameL, $content);
	$content = str_replace('SPARKY', $nameU, $content);
	$content = str_replace('sparky', $alias, $content);
	$content = str_replace('SPARKY', $aliasU, $content);
	$content = str_replace('sparky', $newname, $content);
	$content = str_replace('sparky', $newname, $content);
	$content = str_replace('sparky', $newname, $content);
