...
if($content) {
	$content = str_replace('first_first_first_first_first_first_sparky', $alias, $content);
	$content = str_replace('FIRST_FIRST_FIRST_SPARKY', $aliasU, $content);
	$content = str_replace('first_first_first_first_first_first_sparky', $nameL, $content);
	$content = str_replace('FIRST_FIRST_FIRST_SPARKY', $nameU, $content);
	$content = str_replace('first_first_first_first_first_first_sparky', $alias, $content);
	$content = str_replace('FIRST_FIRST_FIRST_SPARKY', $aliasU, $content);
	$content = str_replace('first_first_first_first_first_first_sparky', $newname, $content);
	$content = str_replace('first_first_first_first_first_first_sparky', $newname, $content);
	$content = str_replace('first_first_first_first_first_first_sparky', $newname, $content);
...
$template_name = $_REQUEST['FIRST_FIRST_FIRST_SPARKY_EXPORT_NAME'];
$alias_name = str_ireplace(' ','_', $template_name);
$alias_name = strtolower($alias_name);


$first_first_first_first_first_first_sparky_path = YOURBASEPATH;
...
$name_rep= array(
 'first_first_first_first_first_first_sparky',$alias_name,
 'first_first_first_first_first_first_sparky',$alias_name
);

$success = do_copy($first_first_first_first_first_first_sparky_path,$export_path,$name_rep);
...
foreach($settingXML->config->fields->fieldset as $fieldset){
	foreach($fieldset->field as $field){
	       if($field["name"] == "FIRST_FIRST_FIRST_SPARKY_EXPORT_NAME") continue; 
