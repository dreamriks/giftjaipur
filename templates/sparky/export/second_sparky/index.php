...
<?php	// template parameters
		...
		// Call second_second_second_second_second_second_sparky Parameters -------------------------------------------------------
		
		require(dirname(__FILE__).DS.'library'.DS.'second_second_second_second_second_second_sparky_parameters.php');
...
<div class="second_second_second_second_second_second_sparky_wrapper">
<?php
...
//$mpostion[2] - number of empty cells left of module 
	...
	if($modules_in_row) {
	?>
    <div class="second_second_second_second_second_second_sparky_full<?php if($gridRow[1]) { echo ' '.$gridRow[1]; } ?>">
        <div class="container">
            ...
            foreach($gridRow[2] as $mpostion) {
				...
				if($mpostion[0] == "joom_content") {		// if content cell
	                ...
	                ?>
	                <div class="content_second_second_second_second_second_second_sparky span<?php echo $mpostion[1];?>">
	                    <div class="cell_pad">
