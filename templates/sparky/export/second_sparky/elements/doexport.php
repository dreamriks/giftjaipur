<?php
/*------------------------------------------------------------------------
# "second_second_second_second_second_second_sparky" - Joomla Template Framework
...
if($content) {
	$content = str_replace('second_second_second_second_second_second_sparky', $alias, $content);
	$content = str_replace('SECOND_SECOND_SECOND_SPARKY', $aliasU, $content);
	$content = str_replace('second_second_second_second_second_second_sparky', $nameL, $content);
	$content = str_replace('SECOND_SECOND_SECOND_SPARKY', $nameU, $content);
	$content = str_replace('second_second_second_second_second_second_sparky', $alias, $content);
	$content = str_replace('SECOND_SECOND_SECOND_SPARKY', $aliasU, $content);
	$content = str_replace('second_second_second_second_second_second_sparky', $newname, $content);
	$content = str_replace('second_second_second_second_second_second_sparky', $newname, $content);
	$content = str_replace('second_second_second_second_second_second_sparky', $newname, $content);
...
$template_name = $_REQUEST['SECOND_SECOND_SECOND_SPARKY_EXPORT_NAME'];
$alias_name = str_ireplace(' ','_', $template_name);
$alias_name = strtolower($alias_name);


$second_second_second_second_second_second_sparky_path = YOURBASEPATH;
...
$name_rep= array(
 'second_second_second_second_second_second_sparky',$alias_name,
 'second_second_second_second_second_second_sparky',$alias_name
);

$success = do_copy($second_second_second_second_second_second_sparky_path,$export_path,$name_rep);
...
foreach($settingXML->config->fields->fieldset as $fieldset){
	foreach($fieldset->field as $field){
	       if($field["name"] == "SECOND_SECOND_SECOND_SPARKY_EXPORT_NAME") continue; 
